          ...
          <div className="col-lg-6">
            <div className="category-featured" data-aos="fade-right" data-aos-delay="200">
              <div className="category-image">
                <img 
                  src={`${process.env.PUBLIC_URL}/assets/img/product/product-f-2.webp`} 
            ...
            <div className="row gy-4">
              <div className="col-12">
                <div className="category-card cat-men" data-aos="fade-up" data-aos-delay="300">
                  <div className="category-image">
                    <img 
                      src={`${process.env.PUBLIC_URL}/assets/img/product/category/4[1] (1).webp`} 
                      alt="Men's Fashion" 
                      className="img-fluid" 
                    />
                  </div>
              ...
              <div className="col-xl-6">
                <div className="category-card cat-kids" data-aos="fade-up" data-aos-delay="400">
                  <div className="category-image">
                    <img 
                      src={`${process.env.PUBLIC_URL}/assets/img/product/product-8.webp`} 
                      alt="Kid's Fashion" 
                      className="img-fluid" 
                    />
                  </div>
              ...
              <div className="col-xl-6">
                <div className="category-card cat-cosmetics" data-aos="fade-up" data-aos-delay="500">
                  <div className="category-image">
                    <img 
                      src={`${process.env.PUBLIC_URL}/assets/img/product/product-3.webp`} 
                      alt="Cosmetics" 
                      className="img-fluid" 
                    />
                  </div>
