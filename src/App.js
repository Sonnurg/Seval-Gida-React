...
/* Fonts */
:root {
  --default-font: "Poiret One", sans-serif; -apple-system, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", "Liberation Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";
...
/* Footer Base */
.footer {
  background-color: #004225; /* koyu yeşil */
  color: #fff;
  padding: 40px 0 20px;
  font-size: 15px;
  line-height: 1.6;
...
.footer-links a:hover {
  color: #7CFC00; /* açık yeşil hover */
}

/* Contact */
.footer-contact p i {
  margin-right: 6px;
  color: #7CFC00; /* ikonları açık yeşil */
}
...
.social-icons a:hover {
  color: #7CFC00;
  transform: scale(1.2); /* büyüyerek hover efekti */
}
